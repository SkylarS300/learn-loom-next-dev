...
-- AddForeignKey
ALTER TABLE `liveheartbeat` ADD CONSTRAINT `liveheartbeat_classroomId_fkey` FOREIGN KEY (`classroomId`) REFERENCES `classroom`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
