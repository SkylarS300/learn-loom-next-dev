// app/admin/support/SupportClient.jsx
"use client";
...
export default function SupportClient() {
    ...
    async function lookup() {
        ...
        try {
            const r = await fetch(`/api/admin/user?${sp.toString()}`, { headers: { "x-support-pass": pass } });
    ...
    return (
        <main style={{ maxWidth: 800, margin: "24px auto", padding: 16 }}>
            ...
            <div style={{ display: "grid", gap: 8, maxWidth: 560 }}>
                <input placeholder="Support password" type="password" value={pass} onChange={(e) => setPass(e.target.value)} style={inp} />
                <input placeholder="Short code (e.g., ABCD-EFGH-123)" value={code} onChange={(e) => setCode(e.target.value)} style={inp} />
