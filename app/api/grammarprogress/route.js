...
export async function POST(req) {
  ...
  let { concept, subTopic, score } = body ?? {};
  if (!concept || !subTopic || (typeof score !== "number" && typeof score !== "string")) {
  ...
  try {
    await prisma.grammarprogress.create({
      data: { anonId, concept: String(concept), subTopic: String(subTopic), score },
    });
