...
export default function Home(){
    ...
    return <div className="home">
      ...
      <div className= "page-wrapper flex flex-row justify-center w-full">

      <div className= "home-content-wrapper max-w-7xl mt-25">
      <div className = "intro-section flex flex-col justify-center text-center gap-5">
        <h1 className = "title text-[36px] font-[600] text-color-[#333]">Your personalized reading companion</h1>
        <p className = "paragraph text-[18px] text-color-[#666] max-w-800">Select a book, explore with our interactive tools, and let Reading Pal guide your learning journey. Discover how we can enhance your reading experience.</p>

        <a href="./login.html" className="cta-button get-started-btn">Get started &rarr;</a>
        
        <div className= "gif-container">
          <img src={demoGif.src} alt="Demo GIF" className="responsive-gif w-full"></img>
        </div>

      </div>
  

  <div id="steps-section" className=  "flex flex-row gap-15 justify-center mt-50">
    <div className= "step flex flex-col justify-center text-center">
  ...
  <div id="features" className= "text-center flex flex-col gap-5 mt-50">
    ...
    <div className =  "features-grid flex flex-row justify-center align-center p-5">
      <div className =  "feature flex flex-col justify-center align-center text-center">
  ...
  <div className =  "flex flex-col gap-5 mt-50" id="faq">

    <div className= "faq-divider"></div>
    <h2 className =  "text-center">Frequently Asked Questions</h2>

    <div className =  "faq-button text-center">FAQ</div>
    <p className =  "text-center">Let us help answer the most common questions you might have.</p>

    <div className =  "faq-container grid grid-cols-2 grid-rows-4 gap-6 p-5">
  ...
  <div id = "footer-cta">
    <div className =  "cta-container flex flex-row justify-center mt-50 mb-50">
      ...
      <a href="./login.html" className= "cta-button">Get started &rarr;</a>
    </div>
